...
if __name__ == "__main__":
    ...
    if args.ours:
        ...
        print("Centroid embed shape second dim: ", centroid_embed.shape[1])
        centroid_embed = centroid_embed.reshape(-1, centroid_embed.shape[1])
        print("Centroid embed overall shape: ", centroid_embed.shape)
    else:
