...
def main():
    ...
    parser.add_argument(
        ...
        default="/network/scratch/q/qian.yang/visual_imagination/llava_lora/llava_lora_warmup_60K_total_133k_1K_clusters_AllSelection_Fastest_Soft_Prev_merged_HF",
    )
    parser.add_argument(
        "--old_state_dict_id",
        help="Location on the hub of the raw state dict of the original model. The filename needs to be `model_state_dict.bin`",
        default="/network/scratch/q/qian.yang/visual_imagination/llava_lora/llava_lora_warmup_60K_total_133k_1K_clusters_AllSelection_Fastest_Soft_Prev_merged",
    )
