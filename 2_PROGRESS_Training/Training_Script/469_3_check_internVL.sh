#!/bin/bash
#SBATCH --job-name=check_internVL_469
#SBATCH --output=check_internVL_469_output.txt
#SBATCH --error=check_internVL_469_error.txt
#SBATCH --ntasks=1

# ============================================================
# Check with InternVL at Step 469 (after 60K warm-up)
...
ACC_OUTPUT_DIR=""                # Directory containing accuracy prediction results (from 469_2_predict_accuracy.sh)
