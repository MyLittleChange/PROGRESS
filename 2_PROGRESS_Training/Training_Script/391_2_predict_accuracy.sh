#!/bin/bash
#SBATCH --job-name=predict_accuracy_391
#SBATCH --output=predict_accuracy_391_output.txt
#SBATCH --error=predict_accuracy_391_error.txt
#SBATCH --ntasks=1

# ============================================================
# Predict Accuracy at Step 391 (after 50K warm-up)
...
CHECKPOINT_DIR=""                # Directory containing the checkpoint at step 391

# Data paths - SET THESE
DATA_PATH=""                     # Path to Top_50K.json (data used for training)
